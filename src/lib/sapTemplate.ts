...
/**
 * NĂM HÀNG TIÊU ĐỀ CỦA TỆP MẪU, chép nguyên xi, đủ cả 116 cột.
 *
 * Phải đủ 116 cột chứ không phải chỉ 29 cột ta dùng. Hệ thống bên kia đọc theo
...
export function dungTepSap(input: DungTepSapInput): TepSap {
  ...
  /**
   * Dựng một dòng đủ 116 ô, đặt từng trường vào ĐÚNG CỘT của nó.
   *
